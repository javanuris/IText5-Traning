...
public class CriminalRefusalNoticeKazTitle extends AbstractNoticeKazTitle {
    ...
    protected void setBodyAdditionalInfo(PdfPTable table, Form103 form103) {
        ...
        String demandThreeStr = String.format("    ҚР ҚПК-нің 494-бабының 1-бөлігіне сәйкес, тиісінше хабардар етілген тараптар келмеген не олардан тиісті арыз келіп түскен жағдайда, іс олардың қатысуынсыз қаралуы мүмкін.", form103.getF8());
        Phrase demandThree = new Phrase(demandThreeStr, FontUtil.openSansRegular(10));
        addCellParagraph(table, demandThree, 1);

        String demandFourStr = String.format("    Электрондық құжаттармен (өтінішхаттың көшірмесімен) танысу үшін Жоғарғы Сот сайтындағы «Сот құжаттарын қарау» модулінде Штрихті Почталық Идентификатордың (ШПИ) сәйкестендіру нөмірін (оң жақ жоғарғы бұрышта) және сот хабарламасында көрсетілген сот отырысы белгіленген күнді енгізу қажет.");
