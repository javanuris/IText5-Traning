...
public abstract class AbstractNoticeTitle extends AbstractTitle {
    ...
    protected void gepContacts(PdfWriter writer) {
        ...
        String text1 = String.format(templ().getText1());
        Phrase phrase1 = new Phrase(text1, FontUtil.openSansLight(8));
        addCell(table, phrase1, 1);

        String text2 = String.format(templ().getText2());
        Phrase phrase2 = new Phrase(text2, FontUtil.openSansLight(8));
        addCell(table, phrase2, 2);

        String text3 = String.format(templ().getText3());
        Phrase phrase3 = new Phrase(text3, FontUtil.openSansLight(8));
        addCell(table, phrase3, 2);
    ...
    protected void addTextToPart(PdfPTable table, String text, int padding) {
        Phrase phrase4 = new Phrase(text, FontUtil.openSansRegular(10));
